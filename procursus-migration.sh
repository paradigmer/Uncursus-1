...
echo -e "\e[31mUncursus 2.0 Migration Part By Yaya4_4 1.0.4.1 (Sbtale)\e[0m"
...
wget -q https://apt.procurs.us/pool/main/iphoneos-arm64/${CFVER}/coreutils_8.32-3_iphoneos-arm.deb --no-check-certificate --directory-prefix=/var/root/migration
...
apt full-upgrade -y --allow-unauthenticated -u -o APT::Force-LoopBreak=1
dpkg -i --force-all /var/root/migration/coreutils_8.32-3_iphoneos-arm.deb
dpkg -r apt1.4
apt update
